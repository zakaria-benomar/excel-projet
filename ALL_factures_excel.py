...
for folder in range(0, 3):
    ...
    for file in glob.glob(path + chemain[folder] + "/*.xlsx"):
        ...
        try:
            ...
            list_files_error.append(file)
            file_arr = file.split("\\")
            copyfile(file,"C:/Users/ATL/Desktop/excel projet/result/files_errors/"+file_arr[len(file_arr)-1])
            continue
        sheet = book.active
...
result.save("C:/Users/ATL/Desktop/excel projet/result/all_factures.xlsx")
...
final_result = load_workbook("C:/Users/ATL/Desktop/excel projet/result/all_factures.xlsx")
...
final_result.save('C:/Users/ATL/Desktop/excel projet/result/all_factures.xlsx')

result_article.save('C:/Users/ATL/Desktop/excel projet/result/Articles.xlsx')

print("list_files_error : " + str(len(list_files_error)))
print(str(list_files_error))